...
class ValueGame:
    ...
    async def load_config(self, character: str, launcher_id: str, launcher_type: str):
        ...
        character_config_path = f"data/plugins/Waifu4/cards/{character}"
        self._config = ConfigManager(character_config_path, f"plugins/Waifu4/templates/default_{launcher_type}")
