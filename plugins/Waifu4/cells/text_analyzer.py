...
class TextAnalyzer:
    ...
    async def _load_yaml_dict(self, file: str) -> Dict[str, list]:
        ...
        config = ConfigManager(f"data/plugins/Waifu4/config/{file}", f"plugins/Waifu4/templates/{file}")
    ...
    def _save_unrecognized_words(self, words: List[str]):
        ...
        """
        existing_words = []
        dict_file_path = f"data/plugins/Waifu4/config/unrecognized_words.yaml"
