...
from plugins.Waifu4.cells.text_analyzer import TextAnalyzer
...
class Memory:
    ...
    def __init__(self, ap: app.Application, launcher_id: str, launcher_type: str):
        ...
        self._long_term_memory_file = f"data/plugins/Waifu4/data/memories_{launcher_id}.json"
        self._conversations_file = f"data/plugins/Waifu4/data/conversations_{launcher_id}.log"
        self._short_term_memory_file = f"data/plugins/Waifu4/data/short_term_memory_{launcher_id}.json"
    ...
    async def load_config(self, character: str, launcher_id: str, launcher_type: str):
        waifu_config = ConfigManager(f"data/plugins/Waifu4/config/waifu", "plugins/Waifu4/templates/waifu", launcher_id)
        ...
        if character != "off":
            self._has_preset = True
            self._status_file = f"data/plugins/Waifu4/data/{character}_{launcher_id}.json"
            character_config = ConfigManager(f"data/plugins/Waifu4/cards/{character}", f"plugins/Waifu4/templates/default_{launcher_type}")
    ...
    def delete_local_files(self):
        files_to_delete = [
            ...
            self._status_file,
            f"data/plugins/Waifu4/data/life_{self._launcher_id}.json",
        ]
